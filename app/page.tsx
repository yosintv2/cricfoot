...
export const metadata: Metadata = {
  ...
  description:
    'CricFoot 14-day football TV guide. Find every match, kick-off time and TV channel for the Premier League, Champions League, La Liga, Serie A, Bundesliga and more.',
