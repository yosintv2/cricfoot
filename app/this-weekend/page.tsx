...
export const metadata: Metadata = {
  title: 'Live Football on TV This Weekend – Saturday & Sunday TV Schedule | CricFoot',
  description:
    'Live Football on TV this weekend: every Saturday and Sunday soccer match with kick-off times in your local timezone and the TV channels broadcasting in your country.',
  keywords:
    'Live Football on TV this weekend, weekend football on tv, soccer this weekend, football this weekend tv schedule, saturday football on tv, sunday football on tv, weekend soccer tv guide',
  openGraph: {
