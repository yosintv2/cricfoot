...
export const metadata: Metadata = {
  title: 'Football TV Schedules by Country – Where to Watch in Your Country | CricFoot',
  description:
    'Football TV guides for every country: see which channels broadcast live soccer in the United States, United Kingdom, Canada, India, Australia and 100+ more countries.',
  keywords:
